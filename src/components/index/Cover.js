...
class Cover extends Component {
  render() {
    return (
      ...
      <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-48 mt-16">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          <a
            href="#"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white focus:ring-4 focus:ring-gray-400"
          >
            Learn more
          </a>
        </div>
