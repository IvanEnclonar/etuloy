...
const Signup = () => {
  ...
  return (
    <div>
      <section class="bg-highlight_hover">
          <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
          <a href="#" class="flex items-center mb-6 text-3xl text-white uppercase font-bold">
              Kami bahala sa'yo!   
          </a>
          <div class="w-full bg-highlight rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                          <label for="terms" class="font-light text-white">I accept the <a class="font-medium text-primary-600 hover:underline" href="#">Terms and Conditions</a></label>
                        </div>
                    </div>
                    <button type="submit" class="w-full text-white bg-highlight_hover hover:bg-higlight_hover focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create an account</button>
